...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'about-page.cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    header: Schema.Attribute.Component<'about-page.header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    mission: Schema.Attribute.Component<'about-page.mission', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Component<'about-page.stats', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    team: Schema.Attribute.Component<'about-page.team', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    values: Schema.Attribute.Component<'about-page.values', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    vision: Schema.Attribute.Component<'about-page.vision', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAdminAdvisorsPageAdminAdvisorsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'admin_advisors_page_pages';
  info: {
    displayName: 'admin-advisors-page';
    pluralName: 'admin-advisors-pages';
    singularName: 'admin-advisors-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admin-advisors-page.admin-advisors-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAdminOverviewPageAdminOverviewPage
  extends Struct.SingleTypeSchema {
  collectionName: 'admin_overview_page_pages';
  info: {
    displayName: 'admin-overview-page';
    pluralName: 'admin-overview-pages';
    singularName: 'admin-overview-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admin-overview-page.admin-overview-page'
    >;
...
export interface ApiAdminPaymentsPageAdminPaymentsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'admin_payments_page_pages';
  info: {
    displayName: 'admin-payments-page';
    pluralName: 'admin-payments-pages';
    singularName: 'admin-payments-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admin-payments-page.admin-payments-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAdminStudentsPageAdminStudentsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'admin_students_page_pages';
  info: {
    displayName: 'admin-students-page';
    pluralName: 'admin-students-pages';
    singularName: 'admin-students-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admin-students-page.admin-students-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAdvisorAppointmentsPageAdvisorAppointmentsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'advisor_appointments_page_pages';
  info: {
    displayName: 'advisor-appointments-page';
    pluralName: 'advisor-appointments-pages';
    singularName: 'advisor-appointments-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advisor-appointments-page.advisor-appointments-page'
    >;
...
export interface ApiAdvisorOverviewPageAdvisorOverviewPage
  extends Struct.SingleTypeSchema {
  collectionName: 'advisor_overview_page_pages';
  info: {
    displayName: 'advisor-overview-page';
    pluralName: 'advisor-overview-pages';
    singularName: 'advisor-overview-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advisor-overview-page.advisor-overview-page'
    >;
...
export interface ApiAdvisorStudentDetailPageAdvisorStudentDetailPage
  extends Struct.SingleTypeSchema {
  collectionName: 'advisor_student_detail_page_pages';
  info: {
    displayName: 'advisor-student-detail-page';
    pluralName: 'advisor-student-detail-pages';
    singularName: 'advisor-student-detail-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advisor-student-detail-page.advisor-student-detail-page'
    >;
...
export interface ApiAdvisorStudentsPageAdvisorStudentsPage
  extends Struct.SingleTypeSchema {
  collectionName: 'advisor_students_page_pages';
  info: {
    displayName: 'advisor-students-page';
    pluralName: 'advisor-students-pages';
    singularName: 'advisor-students-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advisor-students-page.advisor-students-page'
    >;
...
export interface ApiApplicationPageApplicationPage
  extends Struct.SingleTypeSchema {
  collectionName: 'application_page_pages';
  info: {
...
export interface ApiApplicationsPageApplicationsPage
  ...
  attributes: {
    ...
    lastUpdate: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAppointmentPageAppointmentPage
  extends Struct.SingleTypeSchema {
  collectionName: 'appointment_page_pages';
  info: {
    displayName: 'appointment-page';
    pluralName: 'appointment-pages';
    singularName: 'appointment-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::appointment-page.appointment-page'
    >;
...
export interface ApiAuthPageAuthPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    forgotPassword: Schema.Attribute.Component<
    ...
    >;
    login: Schema.Attribute.Component<'auth-page.login', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    register: Schema.Attribute.Component<'auth-page.register', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    resetPassword: Schema.Attribute.Component<
...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    header: Schema.Attribute.Component<'blog-page.header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    page: Schema.Attribute.Component<'blog-page.page', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blogTitle: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<'contact-page.cards', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<'contact-page.faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    header: Schema.Attribute.Component<'contact-page.header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    info: Schema.Attribute.Component<'contact-page.info', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    map: Schema.Attribute.Component<'contact-page.map', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCoursePageCoursePage extends Struct.SingleTypeSchema {
  collectionName: 'course_page_pages';
  info: {
...
export interface ApiDashboardPageDashboardPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    quickTip: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    quickTipText: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    routes: Schema.Attribute.Component<'dashboard-page.routes', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    sidebar: Schema.Attribute.Component<'dashboard-page.sidebar', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDocumentPageDocumentPage extends Struct.SingleTypeSchema {
  collectionName: 'document_page_pages';
  info: {
    displayName: 'document-page';
...
export interface ApiErrorsPageErrorsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'errors-page';
    pluralName: 'errors-pages';
    singularName: 'errors-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::errors-page.errors-page'
    >;
    notFound: Schema.Attribute.Component<'errors-page.not-found', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    runtime: Schema.Attribute.Component<'errors-page.runtime', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'footer.cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    languageSelectLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickLinks: Schema.Attribute.Component<'footer.quick-links', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    appointmentCta: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    bottomNav: Schema.Attribute.Component<'header.bottom-nav', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    brandHighlight: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    followUs: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    menuAriaLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    navLinks: Schema.Attribute.Component<'header.nav-links', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    accommodation: Schema.Attribute.Component<'homepage.accommodation', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    comments: Schema.Attribute.Component<'homepage.comments', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    howToWork: Schema.Attribute.Component<'homepage.how-to-work', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    onlineCourses: Schema.Attribute.Component<
    ...
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'homepage.services', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    statistics: Schema.Attribute.Component<'homepage.statistics', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiKassenbuchPageKassenbuchPage
  extends Struct.SingleTypeSchema {
  collectionName: 'kassenbuch_pages';
  info: {
    displayName: 'kassenbuch-page';
    pluralName: 'kassenbuch-pages';
    singularName: 'kassenbuch-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kassenbuch-page.kassenbuch-page'
    >;
...
export interface ApiMetadataMetadata extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'metadata.about', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    blogPost: Schema.Attribute.Component<'metadata.blog-post', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contact: Schema.Attribute.Component<'metadata.contact', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    hizmetler: Schema.Attribute.Component<'metadata.hizmetler', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    home: Schema.Attribute.Component<'metadata.home', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    impressum: Schema.Attribute.Component<'metadata.impressum', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    pricing: Schema.Attribute.Component<'metadata.pricing', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'metadata.services', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaymentPagePaymentPage extends Struct.SingleTypeSchema {
  collectionName: 'payment_page_pages';
  info: {
...
export interface ApiPricingPagePricingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    packages: Schema.Attribute.Component<'pricing-page.package', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vip: Schema.Attribute.Component<'pricing-page.vip', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    whyUs: Schema.Attribute.Component<'pricing-page.why-us', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProfilePageProfilePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    account: Schema.Attribute.Component<'profile-page.account', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    buttons: Schema.Attribute.Component<'profile-page.buttons', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cv: Schema.Attribute.Component<'profile-page.cv', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    fields: Schema.Attribute.Component<'profile-page.fields', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    options: Schema.Attribute.Component<'profile-page.options', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'profile-page.sections', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    status: Schema.Attribute.Component<'profile-page.status', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    tabs: Schema.Attribute.Component<'profile-page.tabs', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    target: Schema.Attribute.Component<'profile-page.target', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    targetProgram: Schema.Attribute.Component<
      'profile-page.target-program',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    validation: Schema.Attribute.Component<'profile-page.validation', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    visa: Schema.Attribute.Component<'profile-page.visa', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRoutingPageRoutingPage extends Struct.SingleTypeSchema {
  collectionName: 'routing_pages';
  info: {
    displayName: 'routing-page';
    pluralName: 'routing-pages';
    singularName: 'routing-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    common: Schema.Attribute.Component<'routing-page.common', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dokumanlar: Schema.Attribute.Component<'routing-page.dokumanlar', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    kullaniciId: Schema.Attribute.Component<
      'routing-page.kullanici-id',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    kullaniciPost: Schema.Attribute.Component<
      'routing-page.kullanici-post',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::routing-page.routing-page'
    >;
    magaza: Schema.Attribute.Component<'routing-page.magaza', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    routeGroup: Schema.Attribute.Component<'routing-page.route-group', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<'services-page.cards', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    details: Schema.Attribute.Component<'services-page.details', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    header: Schema.Attribute.Component<'services-page.header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    popup: Schema.Attribute.Component<'services-page.popup', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    subscriptionDetails: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSuccessStoriesPageSuccessStoriesPage
  ...
  info: {
    displayName: 'success-stories-page';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Component<'success-stories-page.cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    header: Schema.Attribute.Component<'success-stories-page.header', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Component<'success-stories-page.stats', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    stories: Schema.Attribute.Component<'success-stories-page.stories', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::admin-advisors-page.admin-advisors-page': ApiAdminAdvisorsPageAdminAdvisorsPage;
      'api::admin-overview-page.admin-overview-page': ApiAdminOverviewPageAdminOverviewPage;
      'api::admin-payments-page.admin-payments-page': ApiAdminPaymentsPageAdminPaymentsPage;
      'api::admin-students-page.admin-students-page': ApiAdminStudentsPageAdminStudentsPage;
      'api::advisor-appointments-page.advisor-appointments-page': ApiAdvisorAppointmentsPageAdvisorAppointmentsPage;
      'api::advisor-overview-page.advisor-overview-page': ApiAdvisorOverviewPageAdvisorOverviewPage;
      'api::advisor-student-detail-page.advisor-student-detail-page': ApiAdvisorStudentDetailPageAdvisorStudentDetailPage;
      'api::advisor-students-page.advisor-students-page': ApiAdvisorStudentsPageAdvisorStudentsPage;
      ...
      'api::appointment-page.appointment-page': ApiAppointmentPageAppointmentPage;
